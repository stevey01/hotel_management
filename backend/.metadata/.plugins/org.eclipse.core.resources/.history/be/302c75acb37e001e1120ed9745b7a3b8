...
class GuestdetailsApplicationTests {
	...
	{
		when(guestRepository.findAll()).thenReturn(Stream.of(new Guest(1,9847564,"sam","male","email","capg","madurai")).collect(Collectors.toList()));
...
{
	Guest guest=new Guest((long)1,9847564,"sam","male","email","capg","madurai");
	...
	public void deleteguest()
	{
	   ...
	   @Test
	    void updateGuest() {
		   Guest guest=new Guest((long) 1,9847564,"sam","male","email","capg","sam@gmail.com");
	        Long id = 1L;
